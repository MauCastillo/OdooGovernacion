...
def redirect_with_hash(url, code=303):
    ...
    return "<html><head><script>window.location = '%s' + location.hash;</script><title>Sigeis</title></head></html>" % url
...
HTTP methods). See
http://www.portalemprendedores.com/documentation/11.0/reference/http.html#csrf for
more details.
