...
""" + index_style + """
    ...
    <body>
        ...
        Sale, <b>version 8.0 or later</b>. You can start an <a href='http://www.portalemprendedores.com/start'>online free trial</a>,
        or <a href='http://www.portalemprendedores.com/page/download'>download and install</a> it yourself.
        </p>
        <p>
        For more information on how to setup the Point of Sale with
        the PosBox, please refer to
        <a href='http://www.portalemprendedores.com/documentation/user/point_of_sale/posbox/index.html'>the manual</a>.
        </p>
        <p>
