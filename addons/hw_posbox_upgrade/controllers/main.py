...
<html>
    <head>
        <title>Sigeis's PosBox - Software Upgrade</title>
	...
	<p></p>
        ...
        <a href='http://www.portalemprendedores.com/documentation/user/point_of_sale/posbox/index.html'>PosBox manual</a>
        </p>
        <p>
