...
var DashboardApps = Widget.extend({
    ...
    confirm_upgrade: function() {
        framework.redirect("http://www.portalemprendedores.com/odoo-enterprise/upgrade?num_users=" + (this.data.enterprise_users || 1));
    },
});
...
var DashboardShare = Widget.extend({
    ...
    init: function(parent, data){
        this.data = data;
        this.parent = parent;
        this.share_url = 'http://www.portalemprendedores.com';
